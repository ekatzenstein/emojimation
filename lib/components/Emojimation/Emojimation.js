...
var _emotions = require('./emotions.json');

var _emotions2 = _interopRequireDefault(_emotions);

var _EmojiBackground = require('./EmojiBackground.png');
...
var Emojimation = function (_Component) {
    _inherits(Emojimation, _Component);

    function Emojimation() {
        _classCallCheck(this, Emojimation);

        return _possibleConstructorReturn(this, (Emojimation.__proto__ || Object.getPrototypeOf(Emojimation)).apply(this, arguments));
    }

    _createClass(Emojimation, [{
